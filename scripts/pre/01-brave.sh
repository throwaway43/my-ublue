...
sed -i "$ a repo_gpgcheck=1" /etc/yum.repos.d/brave-browser.repo 
sed -i "$ a type=rpm" /etc/yum.repos.d/brave-browser.repo 
sed -i "$ a gpgcheck=1" /etc/yum.repos.d/brave-browser.repo 
sed -i "$ a gpgkey=file:///etc/pki/rpm-gpg/brave-core.asc" /etc/yum.repos.d/brave-browser.repo 
