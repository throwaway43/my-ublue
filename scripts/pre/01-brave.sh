...
echo "gpgkey=file:///etc/pki/rpm-gpg/brave-core.asc" | tee -a /etc/yum.repos.d/brave-browser.repo
echo "repo_gpgcheck=1" | tee -a /etc/yum.repos.d/brave-browser.repo
echo "gpgcheck=1" | tee -a /etc/yum.repos.d/brave-browser.repo
echo "type=rpm" | tee -a /etc/yum.repos.d/brave-browser.repo
